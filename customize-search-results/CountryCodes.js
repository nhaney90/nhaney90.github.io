define([
	...
	return declare([], {
		...
		getFlagSVG: function(twoDigitCode) {
			return "https://raw.githubusercontent.com/hjnilsson/country-flags/master/png250px/" + twoDigitCode.toLowerCase() + ".png";
		},
		
		getTwoDigitCode: function(threeDigitCode) {;
			return this._twoDigitCodes[threeDigitCode];
		}
